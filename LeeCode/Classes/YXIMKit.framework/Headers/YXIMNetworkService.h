//
//  YXIMNetworkService.h
//  YXIMLib
//
//  Created by arthurzhao on 2022/1/5.
//

#ifndef YXIMNetworkService_h
#define YXIMNetworkService_h

#import <Foundation/Foundation.h>
#import "YXIMMessage.h"
#import "YXIMReadReport.h"
#import "YXIMDeliveryReport.h"
...
// 信令通知
extern NSString *kJanusEventUpdate;
 ...
 */
- (void)onReceiveMessage:(NSArray<YXIMMessage *> *)messages hasMore:(BOOL)hasMore;
...
- (void)onMessageDelivered:(NSArray<YXIMDeliveryReport *> *)delivereds;

/**
消息已读的监听
*/
- (void)onMessageReaded:(NSArray<YXIMReadReport *> *)readeds;
@end
 ...
 */
- (BOOL)onReceiveMessage:(YXIMMessage *)message;
@end
...
/**
 连接服务
 */
@interface YXIMNetworkService : NSObject
...
/**
 ...
 @return 连接服务单例
 */
+ (YXIMNetworkService *)sharedInstance;
