...
// 拉黑错误提示消息
#define MESSAGE_CONTENT_TYPE_Black 1001

// 被删除错误提示消息
#define MESSAGE_CONTENT_TYPE_Delete 1002

//秘钥交换消息
#define MESSAGE_CONTENT_TYPE_ExchangePubKey 10000

#define YXIMString(key) NSLocalizedStringFromTable(key, @"wfc", nil)

#define YXIsCNLanguage [[[NSUserDefaults standardUserDefaults] objectForKey:@"appLanguage"] containsString:@"zh-Han"]
