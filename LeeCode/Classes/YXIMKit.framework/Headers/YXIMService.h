...
#import "YXIMConversationInfo.h"
#import "YXIMUserInfo.h"
#import "YXIMFriendRequest.h"
#import "YXIMConversationSearchInfo.h"
#import "YXIMGroupMember.h"
#import "YXIMGroupSearchInfo.h"
#import "YXIMChatroomInfo.h"
#import "YXIMChatroomMemberInfo.h"
#import "YXIMUnreadCount.h"
#import "YXIMChannelInfo.h"
#import "YXIMAddFriendMessage.h"
#import "YXIMSecretParam.h"
#import "YXIMFriend.h"
#import "YXIMFileRecord.h"
#import "YXIMPCOnlineInfo.h"
...
extern NSString *kMessageListChanged;
...
typedef NS_ENUM(NSInteger, UserSettingScope) {
    ...
    // 通知提示音
    UserSettingScope_Notification_Ring = 1001,
    
    // 通知好友申请
    UserSettingScope_Friends_Request = 1002,
    
    // 好友申请类型 0：同意并添加 1：自动同意并添加 2：永不添加
    UserSettingScope_Friends_Accept_Type = 1003,
    
    // 通过二维码找到我
    UserSettingScope_QR_Find_Me = 1004,
};
 ...
 */
typedef NS_ENUM(NSInteger, YXIMSearchUserType) {
...
typedef NS_ENUM(NSInteger, YXIMPlatformType) {
 ...
 * 对于群组建议使用我们的托管。
 */
@protocol YXIMUserSource <NSObject>
- (YXIMUserInfo *)getUserInfo:(NSString *)userId
                      refresh:(BOOL)refresh;

- (void)getUserInfo:(NSString *)userId
            refresh:(BOOL)refresh
            success:(void(^)(YXIMUserInfo *userInfo))successBlock
              error:(void(^)(int errorCode))errorBlock;


- (void)searchUser:(NSString *)keyword
           success:(void(^)(NSArray<YXIMUserInfo *> *machedUsers))successBlock
             error:(void(^)(int errorCode))errorBlock;
...
// 搜索用户
- (void)searchUser:(NSString *)keyword
        searchType:(YXIMSearchUserType)searchType
              page:(int)page
           success:(void(^)(NSArray<YXIMUserInfo *> *machedUsers))successBlock
             error:(void(^)(int errorCode))errorBlock;
...
/**
 IM服务
 */
@interface YXIMService : NSObject
...
/**
 ...
 @return IM服务单例
 */
+ (YXIMService*)sharedService;


@property(nonatomic, weak)id<YXIMUserSource> userSource;


#pragma mark - 秘钥管理相关

// MARK: 根据targetID获取10个秘钥
- (NSArray *)getSecretKeysByTargetId:(NSString *)targetId;

/// 判断targetId下的秘钥是否过期
- (BOOL)verifySecretKeyWithTargetId:(NSString *)targetId;
...
/**
 ...
 @return 会话信息
 */
- (NSArray<YXIMConversationInfo *> *)getConversationInfos:(NSArray<NSNumber *> *)conversationTypes
...
/**
 ...
 @return 会话信息
 */
- (YXIMConversationInfo *)getConversationInfo:(YXIMConversation *)conversation;
...
/**
 ...
 @return 会话搜索结果信息
 */
- (NSArray<YXIMConversationSearchInfo *> *)searchConversation:(NSString *)keyword inConversation:(NSArray<NSNumber *> *)conversationTypes lines:(NSArray<NSNumber *> *)lines;
 ...
 */
- (void)removeConversation:(YXIMConversation *)conversation
              clearMessage:(BOOL)clearMessage;

// MARK: 删除私密会话
- (void)removePrivateChatConversationWithClearMessage:(BOOL)clearMessage;
...
/**
 ...
 @param top 是否置顶
 */
- (void)setConversation:(YXIMConversation *)conversation
                    top:(BOOL)top
                success:(void(^)(void))successBlock
                  error:(void(^)(int error_code))errorBlock;
...
/**
 ...
 @return 未读数
 */
- (YXIMUnreadCount *)getUnreadCount:(NSArray<NSNumber *> *)conversationTypes
                       lines:(NSArray<NSNumber *> *)lines;
...
/**
 ...
 @return 未读数
 */
- (YXIMUnreadCount *)getUnreadCount:(YXIMConversation *)conversation;
...
/**
 ...
 @param conversation 会话
 */
- (void)clearUnreadStatus:(YXIMConversation *)conversation;
...
/**
 ...
 @return 消息实体
 */
- (NSArray<YXIMMessage *> *)getMessages:(YXIMConversation *)conversation
...
/**
 ...
 @return 消息实体
 */
- (NSArray<YXIMMessage *> *)getMessages:(NSArray<NSNumber *> *)conversationTypes
                                           lines:(NSArray<NSNumber *> *)lines
                                    contentTypes:(NSArray<NSNumber *> *)contentTypes
                                            from:(NSUInteger)fromIndex
                                           count:(NSInteger)count
...
- (NSArray<YXIMMessage *> *)getMessages:(NSArray<NSNumber *> *)conversationTypes
                                           lines:(NSArray<NSNumber *> *)lines
                                   messageStatus:(YXIMMessageStatus)messageStatus
                                            from:(NSUInteger)fromIndex
                                           count:(NSInteger)count
                                        withUser:(NSString *)user;
 ...
 */
- (void)getRemoteMessages:(YXIMConversation *)conversation
                   before:(long long)beforeMessageUid
                    count:(NSUInteger)count
                  success:(void(^)(NSArray<YXIMMessage *> *messages))successBlock
                    error:(void(^)(int error_code))errorBlock;
/**
 获取消息
 ...
 @return 消息实体
 */
- (YXIMMessage *)getMessage:(long)messageId;
...
/**
 ...
 @return 消息实体
 */
- (YXIMMessage *)getMessageByUid:(long long)messageUid;
...
/**
 ...
 @return 命中的消息
 */
- (NSArray<YXIMMessage *> *)searchMessage:(YXIMConversation *)conversation
...
/**
 ...
 @return 消息实体
 */
- (YXIMMessage *)send:(YXIMConversation *)conversation
              content:(YXIMMessageContent *)content
...
/**
 ...
 @return 消息实体
 */
- (YXIMMessage *)sendMedia:(YXIMConversation *)conversation
                   content:(YXIMMessageContent *)content
                   success:(void(^)(long long messageUid, long long timestamp))successBlock
 ...
 */
- (void)recall:(YXIMMessage *)message
       success:(void(^)(void))successBlock
         error:(void(^)(int error_code))errorBlock;
...
- (void)uploadMedia:(NSData *)mediaData
          mediaType:(YXIMMediaType)mediaType
...
/**
 ...
 @param conversation 会话
 */
- (void)clearMessages:(YXIMConversation *)conversation;
...
/**
 ...
 @return 消息内容
 */
- (YXIMMessageContent *)messageContentFromPayload:(YXIMMessagePayload *)payload;
...
/**
 ...
 @return 消息实体
 */
- (YXIMMessage *)insert:(YXIMConversation *)conversation
                 sender:(NSString *)sender
                content:(YXIMMessageContent *)content
                 status:(YXIMMessageStatus)status
                 notify:(BOOL)notify
...
/**
 ...
 @return 本地的用户信息，可能为空
 */
- (YXIMUserInfo *)getUserInfo:(NSString *)userId inGroup:(NSString *)groupId refresh:(BOOL)refresh;
 ...
 */
- (NSArray<YXIMUserInfo *> *)getUserInfos:(NSArray<NSString *> *)userIds inGroup:(NSString *)groupId;
...
// 是否是我的星标好友
- (BOOL)isMyStarFriend:(NSString *)userId;
...
/**
 ...
 @return 好友列表
 */
- (NSArray<YXIMFriend *> *)getFriendList:(BOOL)refresh;
...
/**
 ...
 @return 好友用户信息
 */
- (NSArray<YXIMUserInfo *> *)searchFriends:(NSString *)keyword;
...
/**
 ...
 @return 群组搜索结果
 */
- (NSArray<YXIMGroupSearchInfo *> *)searchGroups:(NSString *)keyword;
...
/**
 ...
 @return 好友请求
 */
- (NSArray<YXIMFriendRequest *> *)getIncommingFriendRequest;
...
/**
 ...
 @return 好友请求
 */
- (NSArray<YXIMFriendRequest *> *)getOutgoingFriendRequest;


/// 获取所有的好友相关请求
- (NSArray<YXIMFriendRequest *> *)getAllFriendRequest;
...
- (void)sendAddFriendMessageWithTarget:(NSString *)target
                               content:(NSString *)content
                               success:(void(^)(void))successBlock
                                 error:(void(^)(int error_code))errorBlock;

// MARK: 接收好友申请回复消息
- (void)loadAddFriendMessagesWithTarget:(NSString *)target
                                success:(void(^)(NSArray<YXIMAddFriendMessage *> *messageList))successBlock
                                  error:(void(^)(int error_code))errorBlock;
...
/**
 ...
 @return 群成员信息
 */
- (NSArray<YXIMGroupMember *> *)getGroupMembers:(NSString *)groupId
...
/**
 ...
 @param refresh 是否强制从服务器更新，如果不刷新则从本地缓存中读取
 */
- (NSArray<YXIMGroupInfo*> *)getMyGroupList:(BOOL)refresh;
...
/**
 ...
 @return 群信息
 */
- (YXIMGroupInfo *)getGroupInfo:(NSString *)groupId
                        refresh:(BOOL)refresh;
...
/**
 ...
 @return 群成员信息
 */
- (YXIMGroupMember *)getGroupMember:(NSString *)groupId
...
/**
 ...
 @return 状态
 */
- (BOOL)isInGroup:(NSString *)groupId;
...
- (void)createGroup:(NSString *)groupId
      ...
      notifyContent:(YXIMMessageContent *)notifyContent
...
/**
 ...
 @param groupId 群ID
 @param froumUid 加入群的邀请人
 @param shareType 添加类型 0 邀请   1 二维码  2 名片
 @param notifyLines 默认传 @[@(0)]
 @param notifyContent 通知消息
 @param successBlock 成功的回调
 @param errorBlock 失败的回调
...
// MARK: 提示音
- (BOOL)isNoticeRing;
- (void)setNoticeRing:(BOOL)hidden
                            success:(void(^)(void))successBlock
                              error:(void(^)(int error_code))errorBlock;

// MARK: 好友申请
- (BOOL)isFriendsRequet;
- (void)setFriendsRequet:(BOOL)hidden
                            success:(void(^)(void))successBlock
                              error:(void(^)(int error_code))errorBlock;
// MARK: 获取好友申请通过类型
- (NSString *)getFriendAcceptType;

// MARK: 设置好友申请通过类型
- (void)setFriendAcceptType:(NSString *)type
                            success:(void(^)(void))successBlock
                              error:(void(^)(int error_code))errorBlock;
...
// MARK: 设置能否二维码添加我
- (void)setQRFindMeType:(BOOL)hidden
                success:(void(^)(void))successBlock
                  error:(void(^)(int error_code))errorBlock;
...
- (void)getChatroomInfo:(NSString *)chatroomId
                ...
                success:(void(^)(YXIMChatroomInfo *chatroomInfo))successBlock
                  error:(void(^)(int error_code))errorBlock;

- (void)getChatroomMemberInfo:(NSString *)chatroomId
                      maxCount:(int)maxCount
                      success:(void(^)(YXIMChatroomMemberInfo *memberInfo))successBlock
                        error:(void(^)(int error_code))errorBlock;
...
- (void)createChannel:(NSString *)channelName
             portrait:(NSString *)channelPortrait
               status:(int)status
                 desc:(NSString *)desc
                extra:(NSString *)extra
            success:(void(^)(YXIMChannelInfo *channelInfo))successBlock
              error:(void(^)(int error_code))errorBlock;
...
/**
 ...
 @return 群信息
 */
- (YXIMChannelInfo *)getChannelInfo:(NSString *)channelId
                            refresh:(BOOL)refresh;
...
/**
 ...
 @param errorBlock 失败的回调
 */
- (void)searchChannel:(NSString *)keyword success:(void(^)(NSArray<YXIMChannelInfo *> *machedChannels))successBlock error:(void(^)(int errorCode))errorBlock;
...
- (void)getGroupMembers:(NSString *)groupId
                refresh:(BOOL)refresh
                success:(void(^)(NSString *groupId, NSArray<YXIMGroupMember *> *))successBlock
                  error:(void(^)(int errorCode))errorBlock;
...
- (void)getGroupInfo:(NSString *)groupId
             refresh:(BOOL)refresh
             success:(void(^)(YXIMGroupInfo *groupInfo))successBlock
               error:(void(^)(int errorCode))errorBlock;
 ...
 */
- (void)clearRemoteConversationMessage:(YXIMConversation *)conversation
                               success:(void(^)(void))successBlock
                                 error:(void(^)(int error_code))errorBlock;
...
*/
- (NSMutableDictionary<NSString *, NSNumber *> *)getMessageDelivery:(YXIMConversation *)conversation;
...
@return 会话的每个用户的已读时间
*/
- (NSMutableDictionary<NSString *, NSNumber *> *)getConversationRead:(YXIMConversation *)conversation;
...
- (void)getMyFiles:(long long)beforeMessageUid
             count:(int)count
           success:(void(^)(NSArray<YXIMFileRecord *> *files))successBlock
             error:(void(^)(int error_code))errorBlock;
...
/**
 ...
 @param errorBlock 失败的回调
 */
- (void)getConversationFiles:(YXIMConversation *)conversation
...
- (void)searchFiles:(NSString *)keyword
       conversation:(YXIMConversation *)conversation
           fromUser:(NSString *)fromUser
   beforeMessageUid:(long long)messageUid
              count:(int)count
            success:(void(^)(NSArray<YXIMFileRecord *> *files))successBlock
...
/**
 ...
 @return 消息实体
 */
- (NSArray<YXIMMessage *> *)getUserMessages:(NSString *)userId
                               conversation:(YXIMConversation *)conversation
                               contentTypes:(NSArray<NSNumber *> *)contentTypes
                                       from:(NSUInteger)fromIndex
                                      count:(NSInteger)count;
...
*/
- (BOOL)updateMessage:(long)messageId status:(YXIMMessageStatus)status;
 ...
 */
- (long)getFirstUnreadMessageId:(YXIMConversation *)conversation;
/**
 清空消息未读。
...
/**
 ...
 @param conversation 会话
 @param messageStatus 消息状态YXIMMessageStatus
 @param fromIndex 起始index
 @param count 总数
 @return 消息实体
 */
...
/**
 ...
 @return 消息实体
 */
- (NSArray<YXIMMessage *> *)searchMessage:(NSArray<NSNumber *> *)conversationTypes
                                    lines:(NSArray<NSNumber *> *)lines
                             contentTypes:(NSArray<NSNumber *> *)contentTypes
                                  keyword:(NSString *)keyword
                                     from:(NSUInteger)fromIndex
...
/**
 ...
 @return 协议栈是否可以发送
 */
- (BOOL)sendSavedMessage:(YXIMMessage *)message
          expireDuration:(int)expireDuration
                 success:(void(^)(long long messageUid, long long timestamp))successBlock
                   error:(void(^)(int error_code))errorBlock;
 ...
 */
- (void)clearMessages:(YXIMConversation *)conversation before:(int64_t)before;
...
/**
 ...
 @return 插入消息的id
 */
- (long)insertMessage:(YXIMMessage *)message;
...
/**
 ...
 @return 会话的消息数。
 */
- (int)getMessageCount:(YXIMConversation *)conversation;
...
/**
 ...
 @return 好友请求
 */
- (YXIMFriendRequest *)getFriendRequest:(NSString *)uerId direction:(int)direction;
 ...
 */
- (NSArray<YXIMGroupMember *> *)getGroupMembers:(NSString *)groupId
                                    type:(YXIMGroupMemberType)memberType;
...
@return PC端在线状态
*/
- (NSArray<YXIMPCOnlineInfo *> *)getPCOnlineInfos;
...
// MARK: 发送会议请求
- (void)sendConferenceRequest:(NSString *)data
                      success:(void(^)(NSString *msgStr))successBlock
                        error:(void(^)(int error_code))errorBlock;
